...
<table cellspacing="0" cellpadding="4" border="0" class="table-form">
    ...
    <tr>
		...
		<td><input type="Text" name="expiry" class="Wdate textinput requireinput required"  id="expiry" onFocus="WdatePicker({skin:'ext',dateFmt:'yyyy-MM-dd',isShowToday:false,lang:'zh_cn',readOnly:true})" style="cursor: hand; width:160px;" value=""></td>
	</tr>
    <tr>
