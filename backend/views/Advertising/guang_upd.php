...
<script type="text/javascript">
 ...
 $('div.ui-dialog-buttonset>button>span.ui-button-text').text('确定');
	...
	<div class="fanwe-body">
		<div class="fb-title"><div><p><span>广告管理 &gt; 编辑广告</span></p></div></div>
		<div class="fb-body">
...
<form action="?g=Admin&m=Adv&a=edit" method="post" name="form_post" id="form_post" enctype="multipart/form-data">
<table cellspacing="0" cellpadding="4" border="0" class="table-form">
	<tbody>
    <tr>
		<th width="200" class="first">广告名称：</th>
		<td><input name="ad_name" type="text"  size="40" class="textinput requireinput required" value="<?php echo $data['ad_name']?>" /></td>
	</tr>
	<tr>
		<th class="first">广告类型：</th>
		<td>
        <select onchange="switch_media_type(this.value)" name="media_type" class="requireinput required">
                 <option value="<?php echo $data['media_type']?>" selected="selected">图片</option>
    ...
    <tr>`
        ...
        <select name="position_id" class="requireinput required">
                <option value="1" selected="selected">天天</option>
                </select>
        </td>
	</tr>
    <tr>
    ...
    <tr>
		...
		<td>
        <input type="Text" name="start_time" class="Wdate requireinput required"  id="start_time" onFocus="WdatePicker({skin:'ext',dateFmt:'yyyy-MM-dd HH:mm',isShowToday:false,lang:'zh_cn',readOnly:true})" style="cursor: hand; width:160px;" value="<?php echo date("Y-m-d H:i:s",$data['start_time'])?>">
        </td>
	</tr>
    <tr>
		<th class="first">结束时间：</th>
		<td>
        <input type="Text" name="end_time" class="Wdate requireinput required"  id="end_time" onFocus="WdatePicker({skin:'ext',dateFmt:'yyyy-MM-dd HH:mm',isShowToday:false,lang:'zh_cn',readOnly:true})" style="cursor: hand; width:160px;" value="<?php echo date("Y-m-d H:i:s",$data['end_time'])?>">
        </td>
	</tr>
</tbody>
</table>
<table cellspacing="0" cellpadding="4" border="0" style="display:block;" class="table-form ad_group group_101">
    ...
    <tr>
		...
		<td><input name="ad_link" type="text"  size="40" class="textinput url" value="<?php echo $data['ad_link']?>" /></td>
	</tr>
    <tr>
    ...
    <tr>
		...
		<td><input name="img_url" type="text"  size="40" class="textinput url" value="http://112233.com" /></td>
	</tr>
</tbody>
</table>
...
<input name="_hash_" type="hidden" value="fddf2eb7a7adc169b855392f4561daec" />
<input name="ad_id" type="hidden" value="12" />
<input type="hidden" name="__hash__" value="af04bedb05a1c39409995686fb33c9bf_94655029afbef9adbe0f221ad780b31d" /></form>
<script type="text/javascript">
