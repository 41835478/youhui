...
<script type="text/javascript">
 ...
 $('div.ui-dialog-buttonset>button>span.ui-button-text').text('确定');
	...
	<div class="fanwe-body">
		<div class="fb-title"><div><p><span>分类管理 &gt; 编辑分类</span></p></div></div>
		<div class="fb-body">
...
<div class="handle-btns">
	<div class="link-button"><p><a class="" href="?r=cate/list" name="" id="">返回列表</a></p></div>
</div>
<form action="?r=cate/edit_do" method="post" name="form_post" id="form_post">
<table cellspacing="0" cellpadding="4" border="0" class="table-form">
    ...
    <tr>
		...
		<td><input name="name" type="text"  size="40" class="textinput requireinput required"   value='<?php echo  $info['name']?>'/></td>
                <input name="id" type="hidden"  size="40" class="textinput requireinput required"   value='<?php echo  $info['id']?>'/>
	</tr>
    <tr>
		<th width="200" class="first">排序：</th>
		<td><input name="sort_order" type="text"  size="10" class="textinput requireinput required number" value="<?php echo $info['sort_order']?>" />(排序为从小到大)</td>
	</tr>
	<tr class="act">
		<th class="first">&nbsp;</th>
		<td>
