...
<script type="text/javascript">
 ...
 $('div.ui-dialog-buttonset>button>span.ui-button-text').text('确定');
	...
	<div class="fanwe-body">
		<div class="fb-title"><div><p><span>角色管理 &gt; 添加角色</span></p></div></div>
		<div class="fb-body">
...
<form action="index.php?r=guanliyuan/add_do" method="post" name="form_post" id="form_post">
<table cellspacing="0" cellpadding="4" border="0" class="table-form">
	<tbody><tr>
		<th width="200" class="first">角色名称：</th>
		<td><input name="role_name" id="role_name" type="text"  size="40" class="textinput requireinput required" value="" /></td>
	</tr>
	<tr class="act">
		<th class="first">&nbsp;</th>
		<td>
...
<input name="_hash_" type="hidden" value="9bdaa8ff0981633dec42d636d316d674" />
<input name="role_id" id="role_id" type="hidden" value="0" />
<input type="hidden" name="__hash__" value="c70ee0e32c4d187473d1e3a776b039ed_8a37ac2a047f4c4ceddb4c0d71e4567f" /></form>
<script type="text/javascript">
