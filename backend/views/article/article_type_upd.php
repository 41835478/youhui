...
<div class="handle-btns">
	<div class="link-button"><p><a class="" href="?r=article/article_type" name="" id="">返回列表</a></p></div>
</div>
<form action="?r=article/article_type_upd_do" method="post">
<table cellspacing="0" cellpadding="4" border="0" class="table-form">
	<tbody>
    <tr>
		<th width="200" class="first">分类名称：</th>
		<td><input name="cate_name" type="text"  size="40" class="textinput requireinput required" value="<?php echo $list['cate_name']?>" /></td>
		<input type="hidden" name="cate_id" value="<?php echo $list['cate_id']?>" />
	</tr>
    <tr>
		<th width="200" class="first">排序：</th>
		<td><input name="sort_order" type="text"  size="10" class="textinput requireinput required number" value="<?php echo $list['sort_order']?>" /></td>
	</tr>
	<tr class="act">
		<th class="first">&nbsp;</th>
		<td>
