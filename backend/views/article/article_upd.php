...
<form action="?r=article/article_upd_do" method="post"  enctype="multipart/form-data">
<table cellspacing="0" cellpadding="4" border="0" class="table-form">
    ...
    <tr>
		...
		<td>
        <select name="cate_id" >
                <option value="1" class="requireinput required"><?php echo $list['cate_name']?></option>
                </select>
        </td>
	</tr>
    <tr>
		<th width="200" class="first">文章标题：</th>
		<td><input name="title" type="text"  size="80" class="textinput requireinput required" value="<?php echo $list['title']?>" /></td>
	</tr>
    <tr>
		<th width="200" class="first">文章别名：</th>
		<td><input name="alias" type="text"  size="20" class="textinput" value="<?php echo $list['alias']?>" /></td>
	</tr>
    <tr>
        <input type="hidden" name="article_id" value="<?php echo $list['article_id']?>" />
		<th class="first">文章内容：</th>
		<td>
        <textarea name="content" id="content" cols="" rows="" class="requireinput required" style="height:460px; width:600px;"><?php echo $list['content']?></textarea>
        <br />
