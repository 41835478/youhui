...
<body>
<form method='post' name="login" id="login" action="?g=Admin&m=User&a=login" >
<div id="login-box">
...
<input type="hidden" name="__hash__" value="b3476c3e518a0426be7e9acfbd2f78bd_a5fe9b18a48b7bdebb26eac89e66eaa3" /></form>
</body>
<script type="text/javascript">
var login_url = '?g=Admin&m=User&a=login&ajax=1';
var index_url = '?g=Admin';
var captcha = false;
